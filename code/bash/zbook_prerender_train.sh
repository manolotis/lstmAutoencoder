...
--data-path "/home/manolotis/sandbox/datasets/waymo_v1.1/uncompressed/tf_example/training/" \
--output-path "/home/manolotis/sandbox/scenario_based_evaluation/lstmEncoderDecoder/data/prerendered/training" \

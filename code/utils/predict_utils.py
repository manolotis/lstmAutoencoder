...
def parse_arguments():
    ...
    parser.add_argument("--n-shards", type=int, required=False, help="n_shards for test data. 1/n_shards will be used")
    parser.add_argument("--num-layers", type=int, required=False, help="# layers for encoder and decoder")
    parser.add_argument("--hidden-size", type=int, required=False, help="size of hidden layers")
...
def get_config(args):
    ...
    if args.hidden_size is not None:
        ...
        config["model"]["decoder"]["hidden_size"] = args.hidden_size
